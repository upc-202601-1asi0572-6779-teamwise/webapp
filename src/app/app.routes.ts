...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./shared/presentation/auth-shell/auth-shell.component').then(
    ...
    children: [
      ...
      },
      {
        path: 'plantaciones',
        loadChildren: () =>
          import('./field-technical-management/presentation/field-technical-management.routes').then(
            (m) => m.plantationRoutes,
          ),
      },
      {
        path: 'dispositivos',
        loadChildren: () =>
          import('./iot-device-management/presentation/iot-device-management.routes').then(
            (m) => m.deviceRoutes,
          ),
      },
      {
        path: 'alertas',
        loadChildren: () =>
          import('./alert-and-notification/presentation/alert-and-notification.routes').then(
            (m) => m.alertRoutes,
          ),
      },
      {
